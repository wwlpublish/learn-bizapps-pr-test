...
**Scenario**
You work for a plumbing and heating company that sells and services smart home devices.  Since many of the devices that you service are smart devices, information from those devices can be captured remotely to aid in the servicing of equipment.  Your organization has several defined scenarios and processes that they use when servicing equipment.  
...
![Sample Solution](../media/47-rg-unit6.png)
