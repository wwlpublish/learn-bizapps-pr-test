...
For more information, see [Connect to files stored in OneDrive for your Power BI app workspace](https://docs.microsoft.com/power-bi/service-connect-to-files-in-app-workspace-onedrive-for-business/?azure-portal=true).
