...
![Screenshot showing "My workspace", the "Datasets" tab, the elipsis, and "Get quick insights".](../media/02-power-bi-desktop-get-quick-insights.png)
...
![Screenshot of the messages, "Searching for insights" followed by "Insights are ready".](../media/02-power-bi-desktop-searching-for-insights.png)
...
Like any other visual, you can interact with the visuals on the **Quick Insights** page. You can also pin any of them to a dashboard or filter to uncover additional insights.
