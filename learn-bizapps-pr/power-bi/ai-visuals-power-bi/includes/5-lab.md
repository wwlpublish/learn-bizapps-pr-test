...
1. Select **Save**.
    ...
    > [!div class="mx-imgBorder"]
    > [![Screenshot of the Power B I Local File tile.](../media/lab-1-d-ssm.png)](../media/lab-1-d-ssm.png#lightbox)
...
1. In the **File Name** box, enter **Sales Exploration**.
    ...
    > [!div class="mx-imgBorder"]
    > [![Screenshot of the Power B I Local File tile.](../media/lab-2-ssm.png)](../media/lab-2-ssm.png#lightbox)
...
1. To create a live connection to the **Sales Analysis** dataset, on the **Home** ribbon tab, from inside the **Data** group, select **Power BI Datasets**.
    ...
    > [!div class="mx-imgBorder"]
    > [![Screenshot of the Power B I Local File tile.](../media/lab-1-f-ssm.png)](../media/lab-1-f-ssm.png#lightbox)
