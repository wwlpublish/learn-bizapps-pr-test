...
For more information, see [Tutorial: Adding formatting options to a Power BI custom visual](/power-bi/developer/custom-visual-develop-tutorial-format-options/?azure-portal=true).
