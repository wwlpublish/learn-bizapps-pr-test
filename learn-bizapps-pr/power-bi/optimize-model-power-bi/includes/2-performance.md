...
> [!div class="mx-imgBorder"]
> [![Screenshot of the Performance analyzer with the Start recording button highlighted.](../media/2-performance-analyzer-overview-ssm.png)](../media/2-performance-analyzer-overview-ssm.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot of the Query editor home tab options.](../media/2-query-editor-home-tab-ssm.png)](../media/2-query-editor-home-tab-ssm.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot of the Column details options.](../media/2-data-preview-column-profile-options-ssm.png)](../media/2-data-preview-column-profile-options-ssm.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot of the Column profiling rows.](../media/2-column-profile-rows-ssm.png)](../media/2-column-profile-rows-ssm.png#lightbox)
