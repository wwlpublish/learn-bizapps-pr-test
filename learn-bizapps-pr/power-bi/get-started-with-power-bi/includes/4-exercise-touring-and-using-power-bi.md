...
So, let's take a quick look at apps, the service, and how it works. We'll go into more detail about apps (and the service) in upcoming modules, but you can think of this as a taste to whet your appetite. You can sign into the service at <a href="https://powerbi.microsoft.co" target="_blank">https://powerbi.microsoft.com</a>. 
