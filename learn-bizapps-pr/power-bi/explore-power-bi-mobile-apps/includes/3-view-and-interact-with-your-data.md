...
You can switch between single-select and multi-select modes in the app settings, as explained in the [Configure app settings](../../explore-power-bi-mobile-apps/6-configure-app-settings.md) unit of this module.
