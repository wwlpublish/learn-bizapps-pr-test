...
You can switch between single-select and multi-select modes in the app settings, as explained in the [Configure app settings](https://docs.microsoft.com/learn/modules/explore-power-bi-mobile-apps/6-configure-app-settings) unit of this module.
