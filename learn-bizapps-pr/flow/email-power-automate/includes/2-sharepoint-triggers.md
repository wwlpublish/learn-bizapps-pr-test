A trigger is the event that starts the flow. For example, if an item is added or edited in a SharePoint list it will trigger a flow to do some actions such as send an email notification.
