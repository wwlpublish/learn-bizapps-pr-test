...
Go to [Power Automate](https://flow.microsoft.com/?azure-portal=true) and sign in with the account that you used to create your environment and database. When you have signed in, select **My Flows > Install > Power Automate Desktop**.
