...
![The Create MODI OCR engine action.](..\media\create-modi-ocr-engine-action.png)
...
![The Create Tesseract OCR engine action.](..\media\create-tesseract-ocr-engine-action.png)
...
![The Extract text with OCR action.](..\media\extract-text-with-ocr-action.png)
...
![The If text on screen action.](..\media\if-text-on-screen-action.png)
...
![The Wait for text on screen action.](..\media\wait-for-text-on-screen.png)

You can also specify whether the text will be extracted from the whole selected source, a specific subregion, or a subregion relative to an image.

As an output, the action produces two variables that describe the exact position of the found text.

![The produced variables of the Wait for text on screen action.](..\media\wait-for-text-on-screen-produced-variables.png)
...
![The Move mouse to text on screen action.](..\media\move-mouse-to-text-on-screen.png)
...
![The produced variables of the Move mouse to text on screen action.](..\media\move-mouse-to-text-on-screen-produced-variables.png)
