Conditional Actions allow Processes to modify their behavior during runtime, based on the available data. they are divided into two major categories in WinAutomation:
