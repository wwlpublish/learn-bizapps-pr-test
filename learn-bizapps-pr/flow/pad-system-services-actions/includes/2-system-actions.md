...
Take a screenshot of the specified screen, all screens, or the foreground window only with the **Take screenshot** action. Save the image file to the clipboard or to a file. To save the screenshot to a file, specify a path and image format.
