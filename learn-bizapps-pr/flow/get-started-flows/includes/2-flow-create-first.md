In the previous unit we learned about the key concepts such as templates, connectors, actions and conditions. Here we'll put all of those concepts into practice by building your very first flow.
