In this exercise, you'll create a policy template to set the host URL at connection creation. This would allow a connection to work with either test or production.
