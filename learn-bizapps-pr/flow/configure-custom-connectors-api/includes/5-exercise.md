...
1.  In a new tab, go to [List used - Microsoft Graph v1.0 | Microsoft Docs](/graph/api/insights-list-used?view=graph-rest-1.0&tabs=http&azure-portal=true) and review the **List Used** that you're going to build a connector for.
