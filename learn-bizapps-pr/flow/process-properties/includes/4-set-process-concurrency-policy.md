WinAutomation supports parallel execution of many instances of the same process. Process concurrency policy allows you to restrict the number of instances that can be run simultaneously. 
