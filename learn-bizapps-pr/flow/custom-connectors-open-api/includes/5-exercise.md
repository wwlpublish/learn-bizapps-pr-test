In this exercise, you will be configuring OpenAPI extensions on the Contoso Invoicing custom connector. You will implement the following extensions:
...
In this task you will import an unmanaged solution that contains a Contoso Invoicing custom connector and test the connector. You will use this connector to complete the tasks in this exercise.
...
1.  Select the **ContosoInvoicingExtensions_1_0_0_0.zip** solution and click **Open**.

1.  Click **Next**.

1.  Click **Import** and wait for the import to complete. You should get a success message after the import completes.

1.  Click **Publish all customizations** and wait for the publish to complete.

1.  Click to open the **Contoso Invoicing - Extensions** solution you imported.

1.  You should see **Contoso Invoicing - Extensions** custom connector component.

1. Select the **Contoso Invoicing -- Extensions** connector and click **Edit**.
...
1. Save this key on a notepad. You will need this key in future tasks.

1. Go back to the connector, select the **Test** tab, and click **+ New connection**.
...
1. Paste the key you copied in the **API Key** field and click **Create connection**.

1. Click **Refresh** connections.

1. Scroll down to the **Operations** section, select **ListInvoiceTypes**, and click Test operation.

    > [!div class="mx-imgBorder"]
    > [![Screenshot of an arrow pointing to the Test operation button.](../media/test-operation.png)](../media/test-operation.png#lightbox)

1. You should get a response containing invoice types. Later you will use this operation to implement the Dynamic Values extension for the Invoice Type parameter.
...
1.  Add the fragment below after the **produces: []** line 7 and click Update connector. Make sure the text indentation matches image below.
...
1.  Type your name or any other random value for **API Key** and click **Create connection**.
...
1.  Provide the Key you copied task 1 as the **API Key** in and click **Create connection**.
...
1.  Scroll down, click on the **...** button of the **typeId** and select **Edit**.
...
1.  Select the **GetInvoiceShema** operation and click **Test operation**.
...
1.  Select **Solutions** and click to open the **Contoso Invoicing -- Extensions** solution.
...
1.  Enter **My connection** for name, enter your name for **API Key**, and click **Create**.
...
1. Provide the Key you copied in task 1 for **API Key** and click **Create** again.
